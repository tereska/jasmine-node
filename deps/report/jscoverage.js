        ...
        if (request.readyState === 4) {
          try {
            ...
            for (file in json) {
              ...
              // Dreamlab changes
              _$jscoverage[file].noTest = fileCoverage.hasOwnProperty('noTest');
              // Dreamlab changes
            }
            jscoverage_recalculateSummaryTab();
            summaryThrobber.style.visibility = 'hidden';
...
//#JSCOVERAGE_ENDIF
  ...
  for (var f = 0; f < files.length; f++) {
    ...
    if(fileCC.noTest){
        ...
        span.innerHTML = '<img style="visibility: visible;" src="exclamation.png" alt="No Test File" title="No Test File"/> ';
